// ApplyTrack Dashboard Message Provider
// Replicates com.example.ui.dashboard.DashboardMessageProvider.kt
...
export const getDashboardMessage = (totalCount) => {
  let list;
  if (totalCount <= 0) {
    list = emptyStateMessages;
  } else if (totalCount >= 1 && totalCount <= 3) {
    list = lowCountMessages;
  } else if (totalCount >= 4 && totalCount <= 9) {
    list = mediumCountMessages;
  } else if (totalCount >= 10 && totalCount <= 19) {
    list = highCountMessages;
  } else if (totalCount >= 20 && totalCount <= 49) {
    list = veryHighCountMessages;
  } else if (totalCount >= 50 && totalCount <= 99) {
    list = ultraHighCountMessages;
  } else {
    list = legendaryCountMessages;
  }
