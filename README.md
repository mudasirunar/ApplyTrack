...
A refined, offline-first personal job application tracker project containing both an Android App and a Web App.

---

## Repository Structure

- **[AndroidApp/](file:///d:/Projects/ApplyTrack/AndroidApp)**: The native Android application codebase.
- **[WebApp/](file:///d:/Projects/ApplyTrack/WebApp)**: The Web application codebase.
...
1. **Clone or Open the Project**:
   - Open Android Studio.
   - Choose **Open** and select the `AndroidApp/ApplyTrack` directory of this repository.
...
2. **Add Configuration File**:
   ...
   - Copy the file into the `app/` folder of this project (`AndroidApp/ApplyTrack/app/google-services.json`).
